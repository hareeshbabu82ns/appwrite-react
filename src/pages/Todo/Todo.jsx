...
import { FetchState, useGetTodos, useGetUser } from "../../hooks";
...
const Todo = () => {
  ...
  const handleAddTodo = async ( e ) => {
    ...
    try {
      await api.createDocument( Server.todosDB, Server.todosCollection, data, [
      ...
      console.error( "Error in adding todo", e );
    }
  };
